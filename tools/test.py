...
pose_animate = su.PoseAnimater((-600, -100), (-900, 300), (-400, 0))
    ...
    try:
        while True:
            ...
            if len(trackobjs_container) >= 2:
                ...
                su.pose_3d_plot(ax, p3ds_coco17)

                su.plot_3d_fence(ax, landmark3ds, (1,0,0))
                plt.savefig(f"../plt/{multi_cam.frame_count}.jpg")
                plt.close()
